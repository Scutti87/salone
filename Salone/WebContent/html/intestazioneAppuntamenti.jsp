...
<head>
    ...
    <title>Intestazione Appuntamenti</title>
...
<body class="min-h-screen bg-gray-50 p-8" style="font-family: Georgia, serif;">
    <div class="container mx-auto relative">
        <div class="flex flex-col items-center justify-center mb-16 relative">
            ...
            <h1 class="text-8xl font-bold text-center bright-red-gradient animate-slide shadow-title" style="font-family: Georgia, serif;">APPUNTAMENTI</h1>
        </div>
        
       <div class="grid grid-cols-5 gap-8">
    <a href="${pageContext.request.contextPath}/html/inserisciAppuntamento.jsp" class="transform hover:scale-125 transition-all duration-300 bg-gradient-button text-black hover:text-white border-2 border-black rounded-lg px-4 py-2 shadow-lg focus:ring-4 focus:ring-red-300 focus:outline-none text-2xl font-bold bg-white special-hover text-center w-auto min-w-[150px]">Nuovo App.</a>
    <a href="${pageContext.request.contextPath}/html/cercaAppuntamento.jsp" class="transform hover:scale-125 transition-all duration-300 bg-gradient-button text-black hover:text-white border-2 border-black rounded-lg px-4 py-2 shadow-lg focus:ring-4 focus:ring-red-300 focus:outline-none text-2xl font-bold bg-white special-hover text-center w-auto min-w-[150px]">Trova App.</a>
    <a href="${pageContext.request.contextPath}/stampaAppuntamenti?vengo=stampa" class="transform hover:scale-125 transition-all duration-300 bg-gradient-button text-black hover:text-white border-2 border-black rounded-lg px-4 py-2 shadow-lg focus:ring-4 focus:ring-red-300 focus:outline-none text-2xl font-bold bg-white special-hover text-center w-auto min-w-[150px]">Lista App.</a>
    
    <form action="${pageContext.request.contextPath}/cercaAppuntamento?vengo=cerca" method="post" class="flex items-center gap-4">
	...
	<br>
	<div class="grid grid-cols-5 gap-8">
    <a href="${pageContext.request.contextPath}/aggiornaStorico" class="transform hover:scale-125 transition-all duration-300 bg-gradient-button text-black hover:text-white border-2 border-black rounded-lg px-4 py-2 shadow-lg focus:ring-4 focus:ring-red-300 focus:outline-none text-2xl font-bold bg-white special-hover text-center w-auto min-w-[150px]">Aggiorna Storico</a>
    
    <form action="${pageContext.request.contextPath}/cercaAppuntamento?vengo=storico" method="post" class="flex items-center gap-4">
        <input placeholder="Nome Cliente"
				name="nome" type="search" class="px-4 py-2 text-2xl border-2 border-black rounded-lg focus:outline-none focus:ring-4 focus:ring-red-300 transition-all duration-300 w-auto min-w-[200px]">
        <button type="submit" class="transform hover:scale-125 transition-all duration-300 bg-gradient-button text-black hover:text-white border-2 border-black rounded-lg px-8 py-2 shadow-lg focus:ring-4 focus:ring-red-300 focus:outline-none text-2xl font-bold bg-white special-hover text-center w-auto min-w-[250px]">Cerca(Sto)🔍</button>
    </form>
